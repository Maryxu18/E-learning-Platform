...
export default function EditParticipantProfile({ navigation }) {
  ...
  const handleSubmitButton = () => {
    fetch(
      "http://localhost:3000/participants/edit-participant-prof/id60e48aaf8f00fe0dd4cc8bc5",
      {
        body:
          "userID=" +
          ID +
    ...
    <div>
      ...
      <div className="other_pages">
        ...
        <p>
          <Text onPress={() => navigation.navigate("LoginScreen")}>
            <a>
              <i color="blue" className="glyphicon glyphicon-expand"></i>
            </a>
          </Text>
        </p>
        <br />
