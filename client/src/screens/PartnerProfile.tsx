...
export default function CreateProfile() {
  ...
  fetch(`http://localhost:3000/partners/view-partner-prof/id${userId}`, {
    headers: {
    ...
    if (responseJson.status === 200 || responseJson.status === 201) {
      responseJson.json().then((data) => {
        ...
        setID(data.data.findOnePartnerData.userID);
        setcompanyName(data.data.findOnePartnerData.companyName);
        setcompanyDescription(data.data.findOnePartnerData.companyDescription);
        setaboutMe(data.data.findOnePartnerData.aboutMe);
        setSkill(data.data.findOnePartnerData.skills);
        setProfessionalBg(data.data.findOnePartnerData.proBackground);
      });
